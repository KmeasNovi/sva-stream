  ...
  return (
    <div className="flex flex-col items-center justify-center gap-7 py-24 min-h-[50vh]">
      ...
      <div className="relative w-24 h-24">
        ...
        <div
          className="absolute inset-0 rounded-full border-[6px] border-t-secondary border-r-primary border-b-transparent border-l-transparent animate-spin shadow-[0_0_30px_rgba(var(--glow-primary),0.4)]"
